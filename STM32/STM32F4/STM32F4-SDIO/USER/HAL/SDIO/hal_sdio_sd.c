      ...
      if (SD_OK == errorstatus)
      {
        /*!< Configure the SDIO peripheral */
				if(SDIO_HIGH_CAPACITY_SD_CARD != SDCardInfo.CardType)
					SDIO_InitStructure.SDIO_ClockDiv = SDIO_TRANSFER_CLK_DIV + 2; /* SDIO_CK for SDSC should not exceed to 12MHz. */
				else
					SDIO_InitStructure.SDIO_ClockDiv = SDIO_TRANSFER_CLK_DIV;
...
/******************************************************************************/
/*                 STM32F4xx SDIO USER-DEFINED initialization Handlers        */
/******************************************************************************/
/**
